function [trainedModel, validationRMSE] = trainRegressionModel_Type2_xlsx(trainingData)
...
% Auto-generated by MATLAB on 23-Sep-2023 09:35:04
...
predictorNames = {'Data_Point', 'Test_Time(s)', 'Step_Time(s)', 'Step_Index', 'Cycle_Index', 'Current(A)', 'Voltage(V)', 'Discharge_Capacity(Ah)', 'Charge_Energy(Wh)', 'Discharge_Energy(Wh)', 'dV/dt(V/s)', 'Internal_Resistance(Ohm)'};
...
trainedModel.RequiredVariables = {'Charge_Energy(Wh)', 'Current(A)', 'Cycle_Index', 'Data_Point', 'Discharge_Capacity(Ah)', 'Discharge_Energy(Wh)', 'Internal_Resistance(Ohm)', 'Step_Index', 'Step_Time(s)', 'Test_Time(s)', 'Voltage(V)', 'dV/dt(V/s)'};
